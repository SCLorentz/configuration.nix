    ...
    switch (resp.response_type)
    {
        ...
        case response_type_auth_message: {
            if (start_req) {
                ...
                string error = _("Unexpected auth question");
                gtkgreet_setup_question(gtkgreet, QuestionTypeInitial, gtkgreet_get_initial_question(), error.c_str());
                break;
            }
...
{
    struct request req = { .request_type = request_type_cancel_session, };
