...
extern "C" int config_update_command_selector([[maybe_unused]] GtkWidget *combobox)
{
    ...
    while(getline(fp, line))
    {
        ...
        //gtk_combo_box_text_append(GTK_COMBO_BOX_TEXT(combobox), NULL, line.c_str());
        g_list_store_append(G_LIST_STORE(model), g_strdup("Option A"));
        //gtk_combo_box_text_append(GTK_COMBO_BOX_TEXT(combobox), line.c_str());
        entries++;
    }
